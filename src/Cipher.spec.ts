...
describe('Cipher.ts', () => {
	...
	describe('Can encrypt', () => {
		...
		test('with plugboard', () => {
			...
			const plugboard = new Plugboard(Wiring.withEnglish(Alphabet.create('AQRIJFHGDEWLTNSXBCOMZVKPYU')));
			const entry = new Wheel(Wiring.withEnglish(Alphabet.createEnglish()));
			const reflector = new Reflector(Wiring.withEnglish(new Alphabet('YRUHQSLDPXNGOKMIEBFZCWVJAT')));
		...
		test('README.md example', () => {
			...
			const plugboard = new Plugboard(
				Wiring.create(Alphabet.create('ABCDEFGHIJKLMNOPQRSTUVWXYZ'), Alphabet.create('AQRIJFHGDEWLTNSXBCOMZVKPYU')),
			);
			const entry = new Wheel(Wiring.withEnglish(Alphabet.createEnglish()));
